...
graph TD
    subgraph Embedding Pipeline
        ...
        Vector["1536-dim Vector (OpenAI) / 384,768 (legacy)"]
...
|-------|-----------|---------|---------|
| **text-embedding-3-small** | **1536** | **n/a** | **Excellent (Production)** |
| **text-embedding-3-large** | **3072** | **n/a** | **Best-in-class (Production)** |
| all-MiniLM-L6-v2 | 384 | mean | Good (legacy) |
| nomic-embed-text | 768 | mean | Better (Ollama default) |
| all-mpnet-base-v2 | 768 | mean | Best in class (legacy) |
| bge-small-en-v1.5 | 384 | cls | Good for retrieval |
| e5-large-v2 | 1024 | mean | Top-tier (open-source)
