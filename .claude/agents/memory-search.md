...
name: memory-search
description: >
  Use this tool to search stored memory for relevant project context,
  user preferences, and prior discussions when additional background
  knowledge is required to answer the user's request accurately.
tools:
