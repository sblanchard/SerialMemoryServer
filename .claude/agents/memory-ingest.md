...
name: memory-ingest
description: >
  Use this tool to store durable, high-value conversation insights,
  user preferences, project decisions, and long-term context in CORE Memory.
  Do not store transient or sensitive information.
tools:
