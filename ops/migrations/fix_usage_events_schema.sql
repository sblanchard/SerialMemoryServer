...
-- Step 6: Update the tenant_id column type if needed (TEXT vs UUID mismatch)
-- The old schema uses TEXT, newer uses UUID - keep as TEXT for compatibility
-- The API uses TEXT for tenant_id in ToolAnalyticsEndpoints
